/*
lab3-search-number.c extra work
Author: Thelma Clarke
SID: 19746069

Search for a number & it's index in an array
what if the target number can be found in multiple positions in the array?
store and print all positions of the target number 
...
input:
./lab3-search-number 4 9 12 4 5 7 8 4 13
output:
...
int main(int argc, char* argv[])
{
    ...
    int i = 2;
    int index;
    /* delare an array of ints, of max len len_array */
    int array_found[len_array];
